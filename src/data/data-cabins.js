...
export const rooms = [
  ...
  },
  {
    ...
    desc: "Indulge in the ultimate luxury family vacation in this medium-sized room 004. Designed for families of up to 4, this room offers a sumptuous retreat for the discerning traveler. Inside, the room boasts of opulent interiors crafted from the finest quality wood, a comfortable living area, a fireplace, and a fully-equipped gourmet kitchen. The bedrooms are adorned with plush beds and spa-inspired en-suite bathrooms. Step outside to your private deck and soak in the natural surroundings while relaxing in your own hot tub.",
  },
  {
    name: "005",
    capacity: 6,
